package com.hyz.hyzweather.sliding;
...
//		this.setBackgroundColor(Color.rgb(255, 255, 255));
		this.setBackgroundResource(R.drawable.banner);
		...
		displayImage = BitmapFactory.decodeResource(context.getResources(), R.drawable.play_display);
		hideImage = BitmapFactory.decodeResource(context.getResources(), R.drawable.play_hide);
